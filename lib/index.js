import gt from "fs";
import I from "path";
import { loadEnv as Rt } from "vite";
...
const jt = {}, $t = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: jt
}, Symbol.toStringTag, { value: "Module" })), X = /* @__PURE__ */ Nt($t);
var ce, Ae;
function Lt() {
  if (Ae) return ce;
  Ae = 1;
...
function K() {
  if (Ge) return Q;
  Ge = 1;
  var t = gt, n = Lt(), o = Tt(), y = Mt(), a = X, s, r;
...
GFS4: `), console.error(e);
  ...
  function h(e) {
    n(e), e.gracefulify = h, e.createReadStream = xt, e.createWriteStream = _t;
    var i = e.readFile;
    e.readFile = f;
    function f(b, _, D) {
      return typeof _ == "function" && (D = _, _ = null), $(b, _, D);
      function $(L, j, C, N) {
        return i(L, j, function(q) {
          q && (q.code === "EMFILE" || q.code === "ENFILE") ? c([$, [L, j, C], q, N || Date.now(), Date.now()]) : typeof C == "function" && C.apply(this, arguments);
        });
      }
    }
    var l = e.writeFile;
    e.writeFile = v;
    function v(b, _, D, $) {
      return typeof D == "function" && ($ = D, D = null), L(b, _, D, $);
      function L(j, C, N, q, T) {
        return l(j, C, N, function(R) {
          R && (R.code === "EMFILE" || R.code === "ENFILE") ? c([L, [j, C, N, q], R, T || Date.now(), Date.now()]) : typeof q == "function" && q.apply(this, arguments);
        });
      }
    }
    var d = e.appendFile;
    ...
    w && (e.copyFile = P);
    function P(b, _, D, $) {
      return typeof D == "function" && ($ = D, D = 0), L(b, _, D, $);
      function L(j, C, N, q, T) {
    ...
    function B(b, _, D) {
      ...
      var $ = x.test(process.version) ? function(C, N, q, T) {
        return O(C, L(
          C,
          N,
          q,
    ...
    function Ot() {
      var b = this;
      ne(b.path, b.flags, b.mode, function(_, D) {
        _ ? (b.autoClose && b.destroy(), b.emit("error", _)) : (b.fd = D, b.emit("open", D), b.read());
      });
    }
    function U(b, _) {
    ...
    function Dt() {
      var b = this;
      ne(b.path, b.flags, b.mode, function(_, D) {
        _ ? (b.destroy(), b.emit("error", _)) : (b.fd = D, b.emit("open", D));
      });
    }
    function xt(b, _) {
      return new e.ReadStream(b, _);
    }
    function _t(b, _) {
      return new e.WriteStream(b, _);
    }
    var qt = e.open;
    e.open = ne;
    function ne(b, _, D, $) {
...
function Wt() {
  if (Ke) return z;
  Ke = 1;
  const t = /* @__PURE__ */ W(), { checkPath: n } = /* @__PURE__ */ It(), o = (y) => {
    const a = { mode: 511 };
...
function J() {
  if (Ve) return fe;
  Ve = 1;
  const t = M().fromPromise, { makeDir: n, makeDirSync: o } = /* @__PURE__ */ Wt(), y = t(n);
  return fe = {
    mkdirs: y,
    mkdirsSync: o,
    // alias
...
function Kt() {
  if (ut) return ge;
  ut = 1;
  const t = M().fromPromise, n = I, o = /* @__PURE__ */ W(), { mkdirs: y, mkdirsSync: a } = /* @__PURE__ */ J(), { symlinkPaths: s, symlinkPathsSync: r } = /* @__PURE__ */ Yt(), { symlinkType: E, symlinkTypeSync: k } = /* @__PURE__ */ Ht(), { pathExists: m } = /* @__PURE__ */ G(), { areIdentical: g } = /* @__PURE__ */ Y();
...
function Vt() {
  if (st) return Pe;
  st = 1;
  const { createFile: t, createFileSync: n } = /* @__PURE__ */ Bt(), { createLink: o, createLinkSync: y } = /* @__PURE__ */ Gt(), { createSymlink: a, createSymlinkSync: s } = /* @__PURE__ */ Kt();
  return Pe = {
    // file
    createFile: t,
    createFileSync: n,
...
function er() {
  if (pt) return Re;
  pt = 1;
  const t = M().fromPromise, n = /* @__PURE__ */ zt();
  return n.outputJson = t(/* @__PURE__ */ Xt()), n.outputJsonSync = /* @__PURE__ */ Zt(), n.outputJSON = n.outputJson, n.outputJSONSync = n.outputJsonSync, n.writeJSON = n.writeJson, n.writeJSONSync = n.writeJsonSync, n.readJSON = n.readJson, n.readJSONSync = n.readJsonSync, Re = n, Re;
}
var Ce, wt;
function tr() {
  if (wt) return Ce;
...
async function sr(t) {
  await H.mkdir(t), H.writeFile(t + "/test.mock.js", cr);
}
async function fr(t) {
  H.writeFile(t, ar);
}
...
function Ft(t) {
  return Rt("local ", bt()).VITE_ENABLE_MOCK === "true" && t === ur;
}
function wr(t = {}) {
  const { mode: n } = t;
  if (!n)
      ...
      Ft(n) && o.middlewares.use(async (y, a, s) => {
        if (y.url.includes("mockServiceWorker.js")) {
          const r = await H.readFile(
            I.resolve(__dirname, "./mockServiceWorker.js"),
            "utf-8"
          );
